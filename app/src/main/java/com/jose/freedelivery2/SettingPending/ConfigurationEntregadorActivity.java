...
public class ConfigurationEntregadorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_configuration_entregador);
        ...
        toolbar.setTitle("Entregas-Pendente");
...
//                    dialog.dismiss();
    ...
    private void inicializarComponentes() {
        recyclerUsuario = findViewById(R.id.recyclerUsuarioew);
    }
