package com.jose.freedelivery2.Update;
...
public class SignUpActivity extends AppCompatActivity {
    ...
    private FirebaseUser autenticacaoEndereco;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_address2);
        ...
        DatabaseReference endereco = FirebaseDatabase.getInstance().getReference().child("Address");
...
//                startActivity(i);
    ...
    private void recueperarDadosUsuario() {
        ...
        DatabaseReference addressref = firebaseRef
